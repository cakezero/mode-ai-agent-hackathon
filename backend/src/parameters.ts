...
export class memeParams extends createToolParameters(
  z.object({
    ...
    tokenSupply: z
      .bigint()
      .describe("The total amount of token to be in circulation"),
  })
) {}

export class tokenParam extends createToolParameters(z.object({})) {}

export class addETHParams extends createToolParameters(
  z.object({
    ETHAmount: z
      .number()
      .describe("The amount of ETH to add to the liquidity pool"),
    MemeAmount: z
      .number()
      .describe("The amount of meme token to add to the liquidity pool"),
  })
) {}
...
export class swapETHParams extends createToolParameters(
  z.object({
    ETHAmount: z
      .number()
      .describe("The amount of Eth to be swapped to meme token"),
  })
) {}
